            ...
            <div class="card-titulo">
                ...
                <?php
          			...
          			else if(isset($_GET["id"]))
          			{
          				//listar
          					$perfil=$daoPerfil->exibir($_SESSION["login"]);
          					$anuncio=$daoAnuncio->listarMeusAnuncios($_SESSION["login"]);
                  ...
                  if(isset($_GET["user"]))
                  {
                    ...
                    foreach ($perfil as $regp)
          					{
                      echo"  <center>
                          <a href='http://127.0.0.1/freela/site.php?func=perfilempregador&id=".$regp->getId()."' class='btn btn-primary'>Editar informações</a>
                          <a href='http://127.0.0.1/freela/site.php?func=perfilempregador&trocarsenha=true&id=".$regp->getId()."' class='btn btn-primary'>Alterar senha</a>
                        </center>";
          					}
                  }
                  ?>
          ...
          <div class="card">
            <div class="card-titulo">
                ...
                <div class="card">
                  <div class="card-content card-titulo">
                    <div>
                      <input type="hidden" id="tipo" name="tipo" value="empregador">
                      <?php
                        foreach ($perfil as $regp)
                        {
            ...
            <?php
            $comentarios=$daoComentarioPerfil->listar($regp->getId(),"empregador");
            foreach ($comentarios as $r)
            {
              ...
              if($r->getUsuario()==$_SESSION["login"])
              {
                  ...
                  echo"<form action='site.php?func=editarcomentarioperfil' method='POST' enctype='multipart/form-data'><div class='card-content card-titulo'>
                      ...
                      <input type='hidden' name='tipo' value='empregador'>
                      ...
                      <a href='http://127.0.0.1/freela/site.php?func=excluircomentarioperfil&t=empregador&id=".$r->getId()."' class='btn btn-primary btn-vg'>Excluir</a>
                  </div></form>";
              }
              else
              {
